...
Make sure to check the coupon code to get the discounts on bus booking online, Tripgo offers a lot of redDeals to book the bus ticket on budget.
            </p>}
          </li>
          <li>
        <Button variant='text' onClick={handleclick2}><h3>How does the transaction appear on my card/account statement?</h3></Button>
        {data2 ? <p></p>:<p>
        Transactions on sks will appear as Tripgo.IN, www.Tripgo.in in your bank statement.  
           </p>}
          </li>
        </ul>
