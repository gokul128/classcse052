    ...
    return (
      <div>
        ...
        Yes, you can track your bus online by using our bus tracking app feature called Track My Bus. This feature allows passengers and their families to track the live bus tracking location. You may follow your bus on a map and use the information to plan your trip to the boarding point and to get off at the correct stop. Family and friends may also check the bus position to plan pick-ups and ensure your safety.
            ...
            <li>
         <Button variant='text' onClick={handleclick1}><h3>What are the advantages of pruchasing a bus ticket with Tripgo ?</h3></Button>
        {data1 ? <p></p>:<p>
...
The convenience doesn't stop here; travelers can even compare onboard amenities like charging points or snacks, further enhancing the travel experience.
        ...
        {data3 ? <p></p>:<p>
        No, you don’t have to create an account on Tripgo site to book your bus ticket. But it is advisable to create one to accelerate the process next time you want to book bus tickets. Also redBus has many discounts and offers that you can easily access if you have an account with us.
            </p>}      
            </li>  
            <li>
            ...
            {data5 ? <p></p>:<p>
            To get the discount on bus booking please visit: https://www.Tripgo.in/info/OfferTerms and check the available offers. Copy the coupon code and paste it during checkout to avail the discount.
                </p>}
            </li>
        </ul>
