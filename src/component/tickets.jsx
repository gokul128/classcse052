...
export const Tickets = () => {
  ...
  return (
    <div>
      ...
      <li>
        <Button variant='text' onClick={handleclick}><h3>How can I book bus tickets on Tripgo?</h3></Button>
        {data ? <p></p>:<p>
...
To know which operators are mTicket enabled, look for the mTicket icon  under the mTicket column while searching for buses.
      ...
      <li>
        ...
        {data5 ? <p></p>:<p>
        You can generate your mTicket online. To generate m-Ticket online click on the Print/SMS ticket link on the redbus home page on www.Tripgo.in. Enter your TIN number mentioned on the e-ticket we emailed you. Choose the SMS option and click on Submit. In case you don’t have a copy of the e-ticket either, contact our call center and our executive will assist you.  
           </p>}
      </li>
      </ul>
